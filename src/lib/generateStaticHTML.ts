...
function generateAmpStoryHtml(story: any) {
  ...
  <html ⚡>
    <head>
      <meta charset="utf-8" />
      <title>${story.title + " | Firebit"}</title>
      <meta name="description" content="${"Web-Story"}">
      <link rel="canonical" href="https://firebit.in/stories/${story.slug}.html" />
      <meta property="og:title" content="${story.title} | Firebit">
      <meta property="og:description" content="Discover a new way of storytelling">
      <meta property="og:image" content="${story.cover.image}">
      <meta name="twitter:card" content="summary_large_image">
      <meta name="viewport" content="width=device-width,minimum-scale=1,initial-scale=1" />
      <meta name="twitter:title" content="${story.title} | Firebit">
      <meta name="twitter:description" content="Discover a new way of storytelling">
      <meta name="twitter:image" content="${story.cover.image}">
